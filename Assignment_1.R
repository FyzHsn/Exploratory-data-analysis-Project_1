...
filename <- "~/JHU_Data_Science/Course_4/Exploratory-data-analysis-Project_1/exdata_data_household_power_consumption/household_power_consumption.txt"
...
## Plot 1
png("~/JHU_Data_Science/Course_4/Exploratory-data-analysis-Project_1/plot1.png", width = 480, height = 480)
hist(data$Global_active_power, col = "red", xlab = "Global Active Power (kilowatts)")
dev.off()

## Plot 2
png("~/JHU_Data_Science/Course_4/Exploratory-data-analysis-Project_1/plot2.png", width = 480, height = 480)
datetime <- paste(data$Date, data$Time)
plot(as.POSIXct(datetime), data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.off()

## Plot 3
png("~/JHU_Data_Science/Course_4/Exploratory-data-analysis-Project_1/plot3.png", width = 480, height = 480)
...
## Plot 4
png("~/JHU_Data_Science/Course_4/Exploratory-data-analysis-Project_1/plot4.png", width = 480, height = 480)
par(mfrow = c(2, 2))
datetime <- paste(data$Date, data$Time)
